...
module.exports = {
   run: async function (client, message, args) {
    ...
    if(snap.val() == null){
      ...
      const mSuporte = new MessageEmbed()
        .setAuthor(message.author.tag, message.author.avatarURL({ dynamic: true }))
        //Removido
        .addField(`☎ | Entre em meu servidor de suporte`, `Você deve clicar [aqui](https://discord.gg/Cj9PZvkqHe) para entrar em meu servidor de suporte.`)
        .setFooter('Zyon Oficial ® 2020', client.user.avatarURL())
        message.channel.send(mSuporte)
