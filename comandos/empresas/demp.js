        ...
        try {
            ...
            if (snap2.val() == null) {
                ...
                if (args[0] == "1") {
                    ...
                    if (!quantidade) return message.channel.send(`<a:erro:809516073799122945> | **${message.author.username}**, você deve me informar o valor que deseja depositar em seu cofre da empresa. Exemplo: \`${prefixo}demp 1 10\``)
