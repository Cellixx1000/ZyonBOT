...
module.exports = {
    run: async function (client, message, args) {
        try {
            ...
            if (!args[0]) return message.channel.send(`<a:erro:809516073799122945> | **${message.author.username}**, você deve me informar o ID da sua empresa, caso não saiba, use: \`${prefixo}empresa\`.`)
            if (args[0] == "1") {
                ...
                if (!descricao) return message.channel.send(`<a:erro:809516073799122945> | **${message.author.username}**, digite o nome em até 30 caracteres!\n• Uso correto: \`${prefixo}nemp <id> <nome>\``)
                if (descricao.length > 30) return message.channel.send(`<a:erro:809516073799122945> | **${message.author.username}**, você utilizou no nome da sua empresa **${descricao.length}** caracteres, você deve usar apenas **30**. Reduza e tente novamente!`)
                if (descricao.length < 5) return message.channel.send(`<a:erro:809516073799122945> | **${message.author.username}**, adicione pelo menos **5** caracteres, você usou apenas **${descricao.length}**.`)
                else {
                    ...
                    message.channel.send(`<:trix_certo:719330454930587689> | **${message.author.username}**, o novo nome da sua empresa é: "**${descricao}**".`)
                }
            }
            if (args[0] == "2") {
